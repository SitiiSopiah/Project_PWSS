...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        ...
        <form
            action="{{ route('kegiatans.update', $kegiatan->id) }}"
            method="POST"
            ...
            <div class="mb-4">
                ...
                <label
                    ...
                    {{ $kegiatan->foto ? 'Ganti Foto' : 'Foto Kegiatan' }}
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    placeholder="Masukkan keterangan kegiatan">{{ old('keterangan', $kegiatan->keterangan) }}</textarea>
