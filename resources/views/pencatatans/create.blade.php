...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <p class="text-muted mb-0">
            Tambahkan hasil pencatatan pemungutan sampah.
        </p>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-header bg-white py-3">
        ...
        <small class="text-muted">
            ...
            Isi data hasil pemungutan sampah.
    ...
    <div class="card-body">
        ...
        <form
            action="{{ route('pencatatans.store') }}"
            method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    placeholder="Contoh: Pemungutan sampah warga RT 01">{{ old('keterangan') }}</textarea>
